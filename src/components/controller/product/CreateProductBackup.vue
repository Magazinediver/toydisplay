...
<!--        <el-form-item label="技术参数" prop="contact">-->
<!--          <el-col :span="16">-->
<!--            <el-input v-model="form.contact"></el-input>-->
<!--          </el-col>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="订货型号" prop="introduce">-->
<!--          <el-col :span="16">-->
<!--            <el-input v-model="form.introduce"></el-input>-->
<!--          </el-col>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="产品概述" prop="attention" >-->
<!--          <el-col :span="20">-->
...
// 封面上传
      ...
      async createActivity() {
        const { data: res } = await this.$http.post('/clubmanage/createactivity',
          this.form
        )
        if (res.meta.status !== 200) {
          return this.$message.error('获取搜索结果失败！')
